...
public class RootMotionControlScript : MonoBehaviour
{
    ...
    void OnAnimatorMove()
    {
        ...
        this.transform.position = Vector3.LerpUnclamped(this.transform.position, newRootPosition, Time.deltaTime * rootMovementSpeed);
        this.transform.rotation = Quaternion.LerpUnclamped(this.transform.rotation, newRootRotation, Time.deltaTime * rootTurnSpeed);
